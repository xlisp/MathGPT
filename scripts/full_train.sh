#!/bin/bash
# MathGPT 完整训练流程（自包含，不依赖外部 nanochat 目录）
# 适配 GTX 1080 (8GB VRAM, SM 6.1, float32)
#
# 用法（从 MathGPT 根目录执行）:
...
# ──────────────────────────────────────────────────────────────
step "3/5  Base 模型预训练（GTX 1080 小配置，depth=6，约 25 分钟）"
...
# ──────────────────────────────────────────────────────────────
step "4/5  SFT 微调（对话格式 + 数学工具调用，约 8 分钟）"
